...
run_MCMC_allcode <- function(seed, data, code, inits, constants, params, params2, niter, nburnin, nthin, nthin2, Tt, piAGE.in, zstAGE, w.in, age.cat.in, S.in.sc_coords, sex.in) {
  ...
  assign('sex.in', sex.in, envir = .GlobalEnv)
  
  # Function to assign sigma.mother to cubs
  ...
  assign('getSexSigma', getSexSigma, envir = .GlobalEnv)
  ...
  conf.mcmc<-configureMCMC(model, monitors = params, thin=nthin, monitors2 = params2, thin2 = nthin2)
