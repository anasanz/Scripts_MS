...
## ------ 2.1.2. Plot density accross years ----
...
pdf("1_ConstantDistCore_pcr.core.pdf",12,6)
...
setwd("D:/MargSalas/Oso/OPSCR_project/Results/Plots/model3.1/Predictions")
pdf("2_DecreasingDistCore_pcr.core.pdf",12,6)
...
## ------ 2.2.2. Plot density accross years ----
...
setwd("D:/MargSalas/Oso/OPSCR_project/Results/Plots/model3.1/Predictions")
pdf("1_ConstantDistCore_pcr.all.pdf",12,6)
...
#maxdens <- max(max(DensityCountriesRegions[[1]]$MeanCell), max(DensityCountriesRegions[[2]]$MeanCell), max(DensityCountriesRegions[[3]]$MeanCell),
#               max(DensityCountriesRegions[[4]]$MeanCell), max(DensityCountriesRegions[[5]]$MeanCell), max(DensityCountriesRegions[[6]]$MeanCell))
maxdens <- 2.3 # Use the max dens of pcr.in core to compare
#plot()
ACDens<-list()
for(t in 1:n.years){
  ACDens[[t]] <- densityInputRegions$regions.r
...
setwd("D:/MargSalas/Oso/OPSCR_project/Results/Plots/model3.1/Predictions")
pdf("2_DecreasingDistCore_pcr.all.pdf",12,6)
...
#maxdens <- max(max(DensityCountriesRegions[[1]]$MeanCell), max(DensityCountriesRegions[[2]]$MeanCell), max(DensityCountriesRegions[[3]]$MeanCell),
#               max(DensityCountriesRegions[[4]]$MeanCell), max(DensityCountriesRegions[[5]]$MeanCell), max(DensityCountriesRegions[[6]]$MeanCell))
maxdens <- 1.65 # Use the max dens of pcr.in core to compare
#plot()
ACDens<-list()
for(t in 1:n.years){
  ACDens[[t]] <- densityInputRegions$regions.r
