...
setwd("D:/MargSalas/Oso/OPSCR_project/Results/Models/3.openSCRdenscov_Age/2021/Cyril/3-3.1_allparams_FINAL/Predictions/20iter_allscin")
...
pdf("prediction_abundance_pcr.all.fem_DemScenFewIter_allscin.pdf", 7, 5)
