...
Xbuf2 <-  readOGR("Buffer_8500_traps_sxyObs_resub.shp") # In resubmission I predict from same buffer as I calculate abundance
...
##########################################################################
#### In resubmission I skip estimating this as I don't use it at the end:
...
# This is for the DISCUSSION SECTION
...
mean(colMeans(pcr_all_fem$pcrmat))  # Value of mean PCR for discussion
