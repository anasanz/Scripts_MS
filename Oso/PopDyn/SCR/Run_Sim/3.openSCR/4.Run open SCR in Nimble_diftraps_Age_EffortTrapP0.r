...
source('3.4.SCRopen_diftraps_Age_trapsCov in Nimble.r')
...
params<-c("p.ad", "p.sub","p.cub","phi.ad","phi.sub","phi.cub", 
          ...
          'b.effort1', 'b.effort2', 'b.trap')

#(1) set up model

model <- nimbleModel(SCRhab.Open.diftraps.age.effortTrapCov, constants = nimConstants, 
