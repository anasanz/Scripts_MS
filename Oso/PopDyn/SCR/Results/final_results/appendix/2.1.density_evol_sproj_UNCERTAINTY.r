...
pdf("SI_2.1.density_evol_allinds4_CILow.pdf", 9,6)
...
maxdens1 <- max(max(DensityCountriesRegions[[1]]$CILCell), max(DensityCountriesRegions[[2]]$CILCell), max(DensityCountriesRegions[[3]]$CILCell),
                max(DensityCountriesRegions[[4]]$CILCell), max(DensityCountriesRegions[[5]]$CILCell))

str(DensityCountriesRegions)
#plot()
ACDens<-list()
for(t in 1:n.years){
  ACDens[[t]] <- densityInputRegions$regions.r
  ACDens[[t]][] <- NA
  ACDens[[t]][!is.na(densityInputRegions$regions.r[])] <- DensityCountriesRegions[[t]]$CILCell
...
maxdens2 <- max(max(DensityCountriesRegions[[1]]$CILCell), max(DensityCountriesRegions[[2]]$CILCell), max(DensityCountriesRegions[[3]]$CILCell),
                max(DensityCountriesRegions[[4]]$CILCell), max(DensityCountriesRegions[[5]]$CILCell), max(DensityCountriesRegions[[6]]$CILCell))
...
maxdens3 <- max(max(DensityCountriesRegions[[1]]$CILCell), max(DensityCountriesRegions[[2]]$CILCell), max(DensityCountriesRegions[[3]]$CILCell),
                max(DensityCountriesRegions[[4]]$CILCell), max(DensityCountriesRegions[[5]]$CILCell), max(DensityCountriesRegions[[6]]$CILCell))
...
setwd("D:/MargSalas/Oso/OPSCR_project/Results/Results_section/Plots")
pdf("SI_2.1.density_evol_allinds4_CIHigh.pdf", 9,6)
...
# Get maximum density of all to scale
maxdens1 <- max(max(DensityCountriesRegions[[1]]$CIHCell), max(DensityCountriesRegions[[2]]$CIHCell), max(DensityCountriesRegions[[3]]$CIHCell),
                max(DensityCountriesRegions[[4]]$CIHCell), max(DensityCountriesRegions[[5]]$CIHCell))
...
for(t in 1:n.years){
  ACDens[[t]] <- densityInputRegions$regions.r
  ACDens[[t]][] <- NA
  ACDens[[t]][!is.na(densityInputRegions$regions.r[])] <- DensityCountriesRegions[[t]]$CIHCell
...
maxdens2 <- max(max(DensityCountriesRegions[[1]]$CIHCell), max(DensityCountriesRegions[[2]]$CIHCell), max(DensityCountriesRegions[[3]]$CIHCell),
                max(DensityCountriesRegions[[4]]$CIHCell), max(DensityCountriesRegions[[5]]$CIHCell), max(DensityCountriesRegions[[6]]$CIHCell))
...
maxdens3 <- max(max(DensityCountriesRegions[[1]]$CIHCell), max(DensityCountriesRegions[[2]]$CIHCell), max(DensityCountriesRegions[[3]]$CIHCell),
                max(DensityCountriesRegions[[4]]$CIHCell), max(DensityCountriesRegions[[5]]$CIHCell), max(DensityCountriesRegions[[6]]$CIHCell))
...
## SD: It's hard because this gives more weight mathematically to high density 
# (just because high numbers have mathematically higher uncertainty)
## CV is similar but just the opposite (corrects for the fact that low numbers have lower uncertainty, so the 0 mess it up)

#### LOAD AND PLOT

setwd("D:/MargSalas/Oso/OPSCR_project/Results/Results_section/Plots")
pdf("SI_2.1.density_evol_allinds4_SD.pdf", 9,6)
...
# Get maximum density of all to scale
maxdens1 <- max(max(DensityCountriesRegions[[1]]$SDCell), max(DensityCountriesRegions[[2]]$SDCell), max(DensityCountriesRegions[[3]]$SDCell),
                max(DensityCountriesRegions[[4]]$SDCell), max(DensityCountriesRegions[[5]]$SDCell))
...
for(t in 1:n.years){
  ACDens[[t]] <- densityInputRegions$regions.r
  ACDens[[t]][] <- NA
  ACDens[[t]][!is.na(densityInputRegions$regions.r[])] <- DensityCountriesRegions[[t]]$SDCell
...
maxdens2 <- max(max(DensityCountriesRegions[[1]]$SDCell), max(DensityCountriesRegions[[2]]$SDCell), max(DensityCountriesRegions[[3]]$SDCell),
                max(DensityCountriesRegions[[4]]$SDCell), max(DensityCountriesRegions[[5]]$SDCell), max(DensityCountriesRegions[[6]]$SDCell))
...
maxdens3 <- max(max(DensityCountriesRegions[[1]]$SDCell), max(DensityCountriesRegions[[2]]$SDCell), max(DensityCountriesRegions[[3]]$SDCell),
                max(DensityCountriesRegions[[4]]$SDCell), max(DensityCountriesRegions[[5]]$SDCell), max(DensityCountriesRegions[[6]]$SDCell))
