...
pdf("density_scale_2021.pdf", 6,9)
...
## ---- Plot only in year 2021 with core/periphery ----

setwd("D:/MargSalas/Oso/OPSCR_project/Results/Plots/model3.1")
pdf("density_scale_2021_corePeri.pdf", 6,9)
...
ACDens2 <- rasterize(Xbuf2, ACDens, mask = TRUE)
plot(ACDens2, xaxt = "n", yaxt = "n", bty = "n", col = palette(), legend = FALSE)
plot(per, col = adjustcolor("#a6dba0", alpha.f = 0.2), border = adjustcolor("#a6dba0", alpha.f = 0.2), add = TRUE)
plot(nuc, col = adjustcolor("#9970ab", alpha.f = 0.2), border = adjustcolor("#9970ab", alpha.f = 0.2), add = TRUE)
...
## ---- Plot only in year 2021 with core/periphery and country borders ----
...
setwd("D:/MargSalas/Oso/OPSCR_project/Results/Plots/model3.1")
pdf("density_scale_2021_corePeri_borders.pdf", 6,9)
...
setwd("D:/MargSalas/Oso/OPSCR_project/Results/Plots/model3.1")
pdf("density_scale_2021_borders.pdf", 6,9)
