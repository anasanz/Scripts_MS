...
setwd("D:/MargSalas/Oso/OPSCR_project/Results/Models/3.openSCRdenscov_Age/2021/Cyril/RESUBMISSION/3-3.3_allparamsNoMove")
...
sum$statistics
sum$statistics[rownames(sum$statistics) %in% c("sigD[1]", "sigD[2]", "sigma[1]", "sigma[2]"), ] * 5
...
setwd("D:/MargSalas/Oso/OPSCR_project/Results/Models/3.openSCRdenscov_Age/2021/Cyril/RESUBMISSION/3-3.3_allparamsNoMove")
save(nimOutput,myResults, file = "myResults_RESUB_3-3.3_NoMove_param.RData")

setwd("D:/MargSalas/Oso/OPSCR_project/Results/Models/3.openSCRdenscov_Age/2021/Cyril/RESUBMISSION/3-3.3_allparamsNoMove")
MCMCtrace(nimOutput, 
          ind = TRUE,
          pdf = TRUE,
          filename = "mcmc_3.3noMove")
...
# Export to process
setwd("D:/MargSalas/Oso/OPSCR_project/Results/Models/3.openSCRdenscov_Age/2021/Cyril/RESUBMISSION/3-3.3_allparamsNoMove")
save(myResultsSXYZ, nimOutputSXY, file = "myResults_RESUB_3-3.3_NoMove_sxy.RData")
