...
os1719_FR <- openxlsx::read.xlsx('Seguiment_Ossos_Pirineus_1996_2021_taula_final_cubLocations.xlsx') %>% 
...
setwd("D:/MargSalas/Oso/Datos/Tablas_finales/2021")
os1719_SP <- openxlsx::read.xlsx('Seguiment_Ossos_Pirineus_1996_2021_taula_final_cubLocations.xlsx') %>% 
...
mapview(itineraires_2020) + mapview(piege_poils2021)
...
setwd("D:/MargSalas/Oso/Datos/Tablas_finales/2021")
os2021_FR<- openxlsx::read.xlsx('Seguiment_Ossos_Pirineus_1996_2021_taula_final_cubLocations.xlsx') %>% 
...
p <- dat2_2021_FR[which(dat2_2021_FR$method == "piege poils"), ]
sum(p$hairtrap, na.rm = TRUE) # 180/214 hairtrap
...
setwd("D:/MargSalas/Oso/Datos/Tablas_finales/2021")
os_add_trap <- openxlsx::read.xlsx('Seguiment_Ossos_Pirineus_1996_2021_taula_final_cubLocations.xlsx') %>%
...
setwd("D:/MargSalas/Oso/Datos/Tablas_finales/2021")
os2021_SP <- openxlsx::read.xlsx('Seguiment_Ossos_Pirineus_1996_2021_taula_final_cubLocations.xlsx') %>%
  filter(Year %in%  c(2020,2021) & Confirmed_Individual != "Indetermined" & Country == "Spain") 
os2021_SP <- os2021_SP %>%
