SCRhab.Open.diftraps.3d.effortTrapSoccCov<-nimbleCode({
  ...
  b.trap~dnorm(0, 0.01)
  b.month~dnorm(0, 0.01)
  b.month.sq~dnorm(0, 0.01)
  ...
  for (t in 1:Nyr){
    ...
    for (k in 1:K){
      ...
      logit(p.eff[1:J[t],k,t]) <- p0 + b.effort1*effort[1:J[t],k,t,1] + b.effort2*effort[1:J[t],k,t,2] + 
        b.trap*trap[1:J[t],t] +
        b.month*m[1:J[t],k,t] + b.month.sq*m[1:J[t],k,t]
