SCRhab.Open.diftraps.3d.effortTrapCov.sigsex<-nimbleCode({
  ...
  for (t in 1:Nyr){
    ...
    for (k in 1:K){
      ...
      logit(p.eff[1:J[t],k,t]) <- p0 + b.effort1*effort[1:J[t],k,t,1] + b.effort2*effort[1:J[t],k,t,2] + b.trap*trap[1:J[t],t]
