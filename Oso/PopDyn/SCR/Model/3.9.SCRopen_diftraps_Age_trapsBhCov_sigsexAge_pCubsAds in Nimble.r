...
## We have seen in 3.8 that p doesn't change when being male or female (p.sex was very low).
## So here we assume that females and males have the same p, and cubs get the p of the adults

SCRhab.Open.diftraps.age.effortTrapBhCov.sigsexage.pcubsads <- nimbleCode({
  ...
  p0[2,1]<-p.ad # pcub =  p of the mother always
  p0[3,1]<-p.ad
  p0[4,1]<-p.sub
  p0[5,1]<-p.sub
  p0[6,1]<-p.ad
