SCRhab.Open.diftraps.3d.effort2p0TrapCov<-nimbleCode({
  ...
  for (t in 1:Nyr){
    ...
    for (k in 1:K){
      ...
      p0.country[1:J[t],k,t]<-getp0(p0=p0[1:2], country=country[1:J[t],k,t])
      
      #calculate baseline detection probability as function of effort, 
      # which varies by year, trap and occasion
      logit(p.eff[1:J[t],k,t]) <- p0.country[1:J[t],k,t] + b.effort1*effort[1:J[t],k,t] + b.trap*trap[1:J[t],t]
