SCRhab.Open.diftraps.3d.effortTrapSexCov<-nimbleCode({
  ...
  for(i in 1:M){
    ...
    for (t in 1:Nyr){
      ...
      for (k in 1:K){
        ...
        # which varies by individual, year, trap and occasion
        logit(p.eff[i,1:J[t],k,t]) <- p0 + b.effort1*effort[1:J[t],k,t,1] + b.effort2*effort[1:J[t],k,t,2] + 
                                      b.trap*trap[1:J[t],t] + b.sex*sex[i]
