...
source('3.6.SCRopen_diftraps_Age_trapsBhCov_sigsex in Nimble.r')
...
modelcode = SCRhab.Open.diftraps.age.effortTrapBhCov.sigsex
...
save(nimData, nimConstants, 
     ...
     params, run_MCMC_allcode, modelcode, file = "Data_Model3-2.RData")
...
model <- nimbleModel(SCRhab.Open.diftraps.age.effortTrapBhCov.sigsex, constants = nimConstants, 
