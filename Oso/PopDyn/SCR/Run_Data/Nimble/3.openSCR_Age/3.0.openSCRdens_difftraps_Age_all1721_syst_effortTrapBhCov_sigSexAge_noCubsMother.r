...
load("tdf2017_nocubsmother_effort.RData")
load("tdf2018_nocubsmother_effort.RData")
load("tdf2019_nocubsmother_effort.RData")
load("tdf2020_nocubsmother_effort.RData")
load("tdf2021_nocubsmother_effort.RData")
...
setwd("D:/MargSalas/Scripts_MS/Stats/Nimble")
source("Parallel Nimble function FOR aNA2_model3-3.r") ##sorry, caps lock...
