...
source('3.8.SCRopen_diftraps_Age_trapsBhCov_sigsexAge_pSex in Nimble.r')

##determine which parameters to monitor
params <- c("p.ad", "p.sub","p.cub", "p.sex", "phi.ad","phi.sub","phi.cub", 
...
modelcode = SCRhab.Open.diftraps.age.effortTrapBhCov.sigsexage.psex
...
save(nimData, nimConstants, 
     inits, Tt, sex.in, piAGE.in, zstAGE, w.in, age.cat.in ,S.in.sc_coords, 
     params, params2, modelcode, file = "Data_Model3-3.2_CYRIL.RData")
...
model <- nimbleModel(SCRhab.Open.diftraps.age.effortTrapBhCov.sigsexage.psex, constants = nimConstants, 
