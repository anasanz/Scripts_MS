...
source('3.7.2.SCRopen_diftraps_Age_trapsBhCov_sigsexAge_tauSexAge in Nimble.r')
...
modelcode = SCRhab.Open.diftraps.age.effortTrapBhCov.sigsexage.tausexage
...
save(nimData, nimConstants, 
     ...
     params, params2, modelcode, file = "Data_Model3-3.3_CYRIL_allparams.RData")
...
model <- nimbleModel(SCRhab.Open.diftraps.age.effortTrapBhCov.sigsexage.tausexage, constants = nimConstants, 
