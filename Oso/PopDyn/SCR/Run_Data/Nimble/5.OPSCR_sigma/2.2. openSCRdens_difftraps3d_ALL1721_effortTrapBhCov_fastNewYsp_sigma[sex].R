...
source("Parallel Nimble function FOR aNA2_model5-2.2_TRY3.r")
...
modelcode = SCRhab.Open.diftraps.3d.effortTrapBhCov.sigSex.fast
...
save(nimData, nimConstants, 
     ...
     params, run_MCMC_allcode, modelcode, file = "Data_Model5-2.2.RData")
