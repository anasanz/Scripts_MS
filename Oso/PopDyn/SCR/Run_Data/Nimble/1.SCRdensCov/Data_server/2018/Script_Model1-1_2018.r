...
#setwd("~/data/data/Scripts_MS/Oso/PopDyn/SCR/Run_Data/Nimble/1.SCRdensCov/Data_server/2018")
...
for (xxx in 1:length(covs)) {
  ...
  save(chain_output, file = paste("Results2018_Model1-1_", covs[xxx], ".RData", sep = ""))
}