...
# Load data
#setwd("D:/MargSalas/Scripts_MS/Oso/PopDyn/SCR/Run_Data/Nimble/1.SCRdensCov/Data_server/2019")
setwd("~/data/data/Scripts_MS/Oso/PopDyn/SCR/Run_Data/Nimble/1.SCRdensCov/Data_server/2020")
...
for (xxx in 1:length(covs)) {
  ...
  save(chain_output, file = paste("Results2020_Model1-1_", covs[xxx], ".RData", sep = ""))
}