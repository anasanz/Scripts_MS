...
# Load data
setwd("D:/MargSalas/Scripts_MS/Oso/PopDyn/SCR/Run_Data/Nimble/1.SCRdensCov/Data_server/2017")
#setwd("~/data/data/Scripts_MS/Oso/PopDyn/SCR/Run_Data/Nimble/1.SCRdensCov/Data_server/2017")
...
save(chain_output, file = paste("Results2017_Model1-1_", covs[xxx], ".RData", sep = ""))
}