...
run_MCMC_allcode <- function(seed, data, code, inits, constants, params, niter, nburnin, nthin, nthin2, Tt, z.in, S.in.sc_coords, getp0) {
  ...
  assign('getp0', getp0, envir = .GlobalEnv)
