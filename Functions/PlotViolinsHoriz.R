...
plot.violinsHoriz<-function(dat.list,x,at=NULL, violin.width=0.20,
                       invlogit=FALSE,ylim=NULL,col="darkblue",cex=0.5,
                       add=FALSE,plot.ci=NULL,border.col="black",alpha=0,
                       fromto=NULL,median=TRUE,horizontal=FALSE){
