...
mapview(cr, map.types = c("Esri.WorldImagery"), col.regions = adjustcolor("#35978f", alpha = 1), col = adjustcolor("black", alpha = 1), lwd = 2, cex = 3) +
...
mapview(cr, map.types = c("Esri.WorldImagery"), col.regions = adjustcolor("#35978f", alpha = 1), col = adjustcolor("black", alpha = 1), lwd = 2, cex = 4) +
