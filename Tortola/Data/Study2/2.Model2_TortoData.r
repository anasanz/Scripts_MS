...
for (xxx in 1:length(transect)){
  ...
  # With jagsUI 
  out <- jags(data1, inits, params, "Model2_study2.txt", n.chain = nc,
              n.thin = nt, n.iter = ni, n.burnin = nb, parallel = TRUE)
  summary <- out$summary
  print(out)
  
  
  setwd("D:/Otros/Tórtola/Results/Study2/Model2")
  save(out, file = paste("2TortoData", "_", transect[xxx], ".RData"), sep = "")
