...
# Seleccionar a̱os del 2007 al 2019
m <- m[,c(6:18)]
# Remove transects only made 2 years
m <- m[-which(rowSums(is.na(m)) > 9), ]
...
# Check which is site 95

x = substr(all.sites,1,nchar(all.sites)-2)
unique(x)[95]
...
load("D:/Ana/Data/Otros/Tortola/data_buff500.rdata")
