...
# RUN ALL YEARS AND TRANSECTS TO CHECK IF THE ERROR THAT I GET WHEN I RESTRICT YEARS/TRANSECTS PERSIST
# IT WORKS! SO THE PROBLEM IS IN THE DATA ARRANGEMENT --> TRY TO FIX IN ARRANGE_DATA_DS AND RUN IN 1.7.2
...
save(out, file = "7tor_1.7.1.RData")
