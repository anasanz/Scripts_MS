...
for (xxx in 1:length(transect)){
  ...
  # MCMC settings
  nc <- 3 ; ni <- 1500000 ; nb <- 150000 ; nt <- 10
  ...
  setwd("~/Scripts_MS/Tortola/Model_results/Models_rerun")
  save(out, file = paste("1.1TortoData_0221_", transect[xxx], "_15e5iter.RData"), sep = "")
